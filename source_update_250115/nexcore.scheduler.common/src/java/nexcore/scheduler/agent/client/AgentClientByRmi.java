 ...
 * <li>서브 업무명 : 배치 코어</li>
 * <li>설  명 : RMI 방식으로 Agent 에 접속하는 client </li>
 * <li>작성일 : 2010. 8. 30.</li>
 * <li>작성자 : 정호철</li>
 * </ul>
 */
public class AgentClientByRmi implements IAgentClient {
	private String            agentId;
	private IAgentService     agentService;
	
	public AgentClientByRmi() {
	}
	...
	public void setAgentService(nexcore.scheduler.entity.IAgentService agentService) {
