...
CREATE TABLE NBS_VIEW_FILTER (
    VF_ID                          INTEGER         NOT NULL GENERATED ALWAYS AS IDENTITY,    /*   */
...
CREATE TABLE NBS_NOTIFY (
    NOTIFY_ID                      INTEGER         NOT NULL GENERATED ALWAYS AS IDENTITY,    /* PK  */
...
CREATE TABLE NBS_NOTIFY_RECEIVER (
    RECEIVER_ID                    INTEGER         NOT NULL GENERATED ALWAYS AS IDENTITY,    /* 수신자 ID  */
...
CREATE TABLE NBS_NOTIFY_SEND_LIST (
    SEQ_NO                         INTEGER         NOT NULL GENERATED ALWAYS AS IDENTITY,    /*   */
    JOB_EXECUTION_ID               VARCHAR(100)    NOT NULL ,    /*   */
    JOB_ID                         VARCHAR(100)    NOT NULL ,    /*   */
