...
CREATE TABLE NBS_ACTIVATION_LOG (
    ...
    JOB_INS_ID_LIST                LONGTEXT                 ,    /* 콤마로 구분된 Job Instance Id 리스트  */
...
CREATE TABLE NBS_VIEW_FILTER (
    VF_ID                          INTEGER         NOT NULL AUTO_INCREMENT,    /*   */
...
CREATE TABLE NBS_NOTIFY (
    NOTIFY_ID                      INTEGER         NOT NULL AUTO_INCREMENT,    /* PK  */
...
CREATE TABLE NBS_NOTIFY_RECEIVER (
    RECEIVER_ID                    INTEGER         NOT NULL AUTO_INCREMENT,    /* 수신자 ID  */
...
CREATE TABLE NBS_NOTIFY_SEND_LIST (
    SEQ_NO                         INTEGER         NOT NULL AUTO_INCREMENT,    /*   */
    JOB_EXECUTION_ID               VARCHAR(100)    NOT NULL ,    /*   */
    JOB_ID                         VARCHAR(100)    NOT NULL ,    /*   */
