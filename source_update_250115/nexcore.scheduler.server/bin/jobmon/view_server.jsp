...
<div class="content-title__wrap">
	<div class="content-title"><%=Label.get("top.menu.server")%></div>
</div>
...
<tr>
    ...
    <th style="width:6%; padding:1px;"><%=Label.get("agent.os")%></th>
    <th style="width:6%; padding:1px;"><%=Label.get("agent.java.version")%></th>
    <th style="width:6%; padding:1px; word-break:keep-all"><%=Label.get("agent.version")%></th>
<!--
...
%>
            <tr>
                ...
                <td style="padding:1px;">
                    <table class="Table njf-table__typea Width-100" id="tableList">
                        <tr>
                            <th style="height: 15px; padding:1px; font-weight: normal;"><%=Label.get("agent.heap")%></th>
                            <th style="height: 15px; padding:1px; font-weight: normal; vertical-align: top;" rowspan="2"><%=Label.get("agent.heap.init")%></th>
                            <td style="height: 15px; padding:1px; text-align:right"><%=byteToMega(mem.get("HEAP_INIT"))%> </td>
                            <th style="height: 15px; padding:1px; font-weight: normal; vertical-align: top;" rowspan="2"><%=Label.get("agent.heap.max")%></th>
                            ...
                            <th style="height: 15px; padding:1px; font-weight: normal; vertical-align: top;" rowspan="2"><%=Label.get("agent.heap.use")%></th>
...
%>
                        <tr>
                            <th style="height: 15px; padding:1px; font-weight: normal;"><%=Label.get("agent.nonheap")%></th>
