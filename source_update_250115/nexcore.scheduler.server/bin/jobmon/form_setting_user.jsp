...
<% /* ================== User °ü·Ã ÇÔ¼ö ======================*/ %>
	function checkSubmit() {
		if (document.form1.id.value.trim() == '') {
			...
			alert('<%=Label.get("common.required.field.missing", Label.get("user.password.confirm"))%>');
			return false;
		}
...
<div class="header-wrap Margin-bottom-5">
	<div class="header">
		<div class="header-title">
			<%=isEditMode ? Label.get("user.edit.popup.title") : Label.get("user.add.popup.title") %>
		</div>
