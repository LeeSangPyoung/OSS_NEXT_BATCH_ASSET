...
<div class="header-wrap Margin-bottom-5">
	<div class="header">
		<div class="header-title">
			<%=isEditMode ? Label.get("notify.receiver.edit.popup.title") : Label.get("notify.receiver.add.popup.title") %>
		</div>
...
<!--  
<tr>
    <th><%=Label.get("notify.terminal")%></th>
    <td><%=printRadioOptionAlx("recvByTerminal", "true",  String.valueOf(receiver.isRecvByTerminal()), Label.get("notify.true"))%>
        ...
        <input class="Textinput Margin-left-10" style="width:77.4%" type="text" name="terminalId" value="<%=conv(receiver.getTerminalId())%>"></td>
</tr>
<tr>
    <th><%=Label.get("notify.messenger")%></th>
    <td><%=printRadioOptionAlx("recvByMessenger", "true",  String.valueOf(receiver.isRecvByMessenger()), Label.get("notify.true"))%>
        ...
        <input class="Textinput Margin-left-10" style="width:77.4%" type="text" name="messengerId" value="<%=conv(receiver.getMessengerId())%>"></td>
</tr>
<tr>
    <th><%=Label.get("notify.dev1")%></th>
    <td><%=printRadioOptionAlx("recvByDev1", "true",  String.valueOf(receiver.isRecvByDev1()), Label.get("notify.true"))%>
        ...
        <input class="Textinput Margin-left-10" style="width:77.4%" type="text" name="dev1Point" value="<%=conv(receiver.getDev1Point())%>"></td>
</tr>
<tr>
    <th><%=Label.get("notify.dev2")%></th>
    <td><%=printRadioOptionAlx("recvByDev2", "true",  String.valueOf(receiver.isRecvByDev2()), Label.get("notify.true"))%>
        ...
        <input class="Textinput Margin-left-10" style="width:77.4%" type="text" name="dev2Point" value="<%=conv(receiver.getDev2Point())%>"></td>
</tr>
<tr>
    <th><%=Label.get("notify.dev3")%></th>
    <td><%=printRadioOptionAlx("recvByDev3", "true",  String.valueOf(receiver.isRecvByDev3()), Label.get("notify.true"))%>
        ...
        <input class="Textinput Margin-left-10" style="width:77.4%" type="text" name="dev3Point" value="<%=conv(receiver.getDev3Point())%>"></td>
</tr>
-->
<%
	if (isEditMode) {
