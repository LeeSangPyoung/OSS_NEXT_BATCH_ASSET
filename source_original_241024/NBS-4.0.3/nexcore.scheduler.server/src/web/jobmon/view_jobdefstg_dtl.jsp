...
<title><%=Label.get("jobdefstg")%> (<%=jobid%>)</title>
</head>
...
<div class="header-wrap Margin-bottom-5">
	<div class="header">
		<div class="header-title">
			<%=Label.get("jobdefstg")+" ("+Label.get("reqtype."+jobdef.getReqType())+")"%> [<%=nvl(jobdef.getJobId())%>]
		</div>
...
<%-- <br>
<table border="0" width="80%">
<tr><td colspan="100%" align="left"><font size="3"><b>¡á <%=Label.get("jobdefstg.request.title")%></b></font></td></tr>
</table> --%>
<!-- <table border="2" style = "border-collapse:collapse" bordercolor = "#000000" cellpadding="3" width="80%"> -->
<table class="Table njf-table__typea Width-100" >
    <colgroup>
...
<%-- <br>
<table border="0" width="80%">
<tr><td colspan="100%" align="left"><font size="3"><b>¡á <%=Label.get("jobdefstg.approval.title")%></b></font></td></tr>
</table> --%>
<!-- <table border="2" style = "border-collapse:collapse" bordercolor = "#000000" cellpadding="3" width="80%"> -->
