...
CREATE TABLE NBS_ACTIVATION_LOG (
    ...
    JOB_INS_ID_LIST                TEXT                     ,    /* 콤마로 구분된 Job Instance Id 리스트  */
...
CREATE TABLE NBS_NOTIFY_RECEIVER (
    RECEIVER_ID                    INTEGER         IDENTITY ,    /* 수신자 ID  */
