...
<% /* ============ JobGroup 속성 정의 관련 함수 ===================*/ %>
    ...
    function addJobGroupAttrDef() {
    	...
    	if(id == null || id == "" || typeof id =="undefined") {
    		alert('<%=Label.get("common.required.field.missing", "ID")%>');
	...
	$(document).ready(function () {
		...
		var title = "<%=Label.get("jobgroup")+" "+Label.get("common.attribute")+" "+Label.get("common.btn.add")%>";
...
<thead>
<tr>
    <th style="padding:3px; width:8%">ID</th>
    <th style="padding:3px; width:8%"><%=Label.get("common.name")%></th>
    <th style="padding:3px; width:20%"><%=Label.get("common.desc")%></th>
    <th style="padding:3px; width:12%"><%=Label.get("jobgroup.value.type")%></th>
    <th style="padding:3px; width:10%"><%=Label.get("jobgroup.value.check")%></th>
    <th style="padding:3px; width:5%"><%=Label.get("jobgroup.display.line")%></th>
    <th style="padding:3px; width:10%"><%=Label.get("jobgroup.display.monitor")%></th>
    <th style="padding:3px; width:5%"><%=Label.get("jobgroup.display.order")%></th>
...
<div>
	...
	<div id="dialogId" class="Dialog" style="display:none">
	    <div class="Dialog-contents">
			...
			<thead>
			<tr>
			    <th class="required" style="padding:3px; width:8%">ID</th>
			    <th class="required" style="padding:3px; width:8%"><%=Label.get("common.name")%></th>
			    <th style="padding:3px; width:20%"><%=Label.get("common.desc")%></th>
			    <th style="padding:3px; width:12%"><%=Label.get("jobgroup.value.type")%></th>
			    <th style="padding:3px; width:10%"><%=Label.get("jobgroup.value.check")%></th>
			    <th style="padding:3px; width:5%"><%=Label.get("jobgroup.display.line")%></th>
