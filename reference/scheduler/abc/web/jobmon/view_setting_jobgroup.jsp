...
<tr>
    ...
    <th style="width:5%"><a href="javascript:orderby('getName');"><%=Label.get("common.name")%><%=printSortMark(orderby, orderdir, "getName")%></a></th>
    <th style="width:5%"><a href="javascript:orderby('getDesc');"><%=Label.get("common.desc")%><%=printSortMark(orderby, orderdir, "getDesc")%></a></th>
<%
